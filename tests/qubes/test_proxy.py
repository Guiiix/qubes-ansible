        ...
        if inventory:
            if inventory_format == "ini":
                ...
                with open(inventory_path, "w") as inventory_file:
                    inventory_content.write(inventory_file,
...
def test_proxy_with_simple_local_playbook(run_playbook):
    ...
    assert "Could not match supplied host pattern" not in result.stderr, result.stderr
